...
const categories = ["CleanTech", "HealthTech", "EdTech", "Logistics", "Web3", "GovTech", "FinTech", "Other"];
  ...
  return (
    <div className="min-h-screen pb-24 relative">
      ...
      <div className="max-w-2xl mx-auto px-4 sm:px-6 pt-8 sm:pt-12 relative z-10">
          ...
          {step === 2 && (
            <div className="space-y-5 sm:space-y-6 animate-fade-in">
              ...
              <InputField label="Funding Goal (ETH)" error={errors.goal}>
                ...
                {/* Quick select — scrollable on mobile */}
              ...
              {form.goal && (
                <div className="bg-emerald-500/5 border border-emerald-500/20 rounded-xl sm:rounded-2xl p-4 sm:p-5 space-y-2.5 sm:space-y-3">
                  ...
                  {[
                    { label: "Total token supply", value: "10,000 tokens" },
                    { label: "Price per token", value: `${(parseFloat(form.goal) / 10000).toFixed(4)} ETH` },
                    ...
                    <div key={i} className="flex justify-between items-center text-xs sm:text-sm">
                      ...
                      <span className={`font-bold ${row.highlight ? "text-emerald-400" : "text-white"}`}>
                        {row.value}
                      </span>
                    </div>
                  ))}
            ...
            <div className="space-y-5 sm:space-y-6 animate-fade-in">
              ...
              >
                <textarea
                  ...
                  onChange={(e) => set("milestoneDescription", e.target.value.slice(0, 300))}
                  rows={4}
                  className={`w-full bg-slate-800/50 border text-white placeholder-slate-600 px-3 sm:px-4 py-2.5 sm:py-3 rounded-xl focus:outline-none focus:ring-1 transition-all text-sm resize-none ${
              ...
              <InputField label="Token Symbol" hint="Max 5 characters" error={errors.tokenSymbol}>
                <div className="relative">
                  <input
                    ...
                    onChange={(e) => set("tokenSymbol", e.target.value.toUpperCase().slice(0, 5))}
            ...
            <div className="animate-fade-in">
              ...
              <div className="space-y-3 sm:space-y-4">
                <div className="glass-card rounded-xl sm:rounded-2xl p-4 sm:p-5">
                  ...
                  <ReviewRow
                    label="Description"
                    value={form.description.slice(0, 60) + (form.description.length > 60 ? "..." : "")}
                  />
                </div>
                ...
                <div className="glass-card rounded-xl sm:rounded-2xl p-4 sm:p-5">
                  ...
                  <ReviewRow
                    label="Description"
                    value={form.milestoneDescription.slice(0, 80) + (form.milestoneDescription.length > 80 ? "..." : "")}
                  />
          ...
          <div className="flex items-center justify-between mt-6 sm:mt-8 pt-5 sm:pt-6 border-t border-white/5">
            ...
            {step < 4 ? (
              ...
              <button
                ...
                className="flex items-center gap-2 bg-emerald-600 hover:bg-emerald-500 text-white font-bold px-6 sm:px-8 py-2.5 sm:py-3 rounded-xl transition-all active:scale-95 shadow-lg shadow-emerald-900/40 text-sm"
              >
        ...
        {/* Step counter for mobile — bottom hint */}
